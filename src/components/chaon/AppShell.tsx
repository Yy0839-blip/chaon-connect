        ...
        <header className="sticky top-2 z-30 -mx-5 px-5 py-2.5">
          <div className="glass flex w-full items-center justify-between rounded-[24px] px-3 py-2.5">
            <Link to="/" className="tap flex min-w-0 items-center gap-2.5">
              <span className="bg-sunrise shine grid size-10 shrink-0 place-items-center rounded-[15px] font-display text-lg text-primary-foreground shadow-pop">
                차
              </span>
              <span className="min-w-0 leading-none">
                <span className="text-grad block font-display text-xl tracking-tight">차온</span>
                <span className="mt-0.5 block truncate text-[9px] font-bold tracking-[0.24em] text-muted-foreground">
                  대야동 · 차오름
                </span>
              </span>
            </Link>
            ...
            <div className="flex shrink-0 items-center gap-2">
              <span className="bg-sunrise flex items-center gap-1.5 rounded-full px-3 py-1.5 text-xs font-bold text-primary-foreground shadow-pop" aria-label={`${points} 포인트`}>
